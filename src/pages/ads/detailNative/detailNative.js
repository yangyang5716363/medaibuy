...
import { nativeDetailList, nativeDetaiAnalysis, collection, cancelCollection, } from '@/services/ads'
import './styles.scss'
...
export default class extends PureComponent {
  ...
  mirrorData (result) {
    ...
    // cache.images = { type: 'static', src: adInfoVO.url }
